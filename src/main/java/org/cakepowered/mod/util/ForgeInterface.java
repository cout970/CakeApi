...
public class ForgeInterface {
	...
	public static Vector3 getVector3(BlockPos pos) {
		if (pos == null)
			return null;
	...
	public static Vector3 getVector3(Vec3d v) {
	...
	public static NBTBase getNBT(net.minecraft.nbt.NBTBase tag) {
		...
		if (tag instanceof NBTTagCompound) {
			return new ApiNBTCompound((NBTTagCompound) tag);
		}
	...
	public static Biome getBiome(net.minecraft.world.biome.Biome biome) {
