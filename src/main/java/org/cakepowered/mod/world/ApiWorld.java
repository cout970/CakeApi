...
public class ApiWorld implements org.cakepowered.api.world.World, IImplementation<World> {
    ...
    public BlockLocation getSpawnLocation() {
        return new BlockLocation(world.provider.getDimension(), world.getSpawnPoint().getX(), world.getSpawnPoint().getY(),
    ...
    public void playSoundAtEntity(Entity entity, String soundName, float volume, float pitch) {
        playSoundEffect(entity.getPosition().getXd(), entity.getPosition().getYd(), entity.getPosition().getZd(), soundName, volume, pitch);
    }

    @Override
    public void playSoundEffect(double x, double y, double z, String soundName, float volume, float pitch) {
        SoundEvent event = SoundEvent.REGISTRY.getObject(new ResourceLocation(soundName));
        world.playSound(x, y, z, event, SoundCategory.BLOCKS, volume, pitch, false);
    }
