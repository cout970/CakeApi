...
public class SurfaceWorldProvider extends WorldProvider {
	...
	public IChunkProvider createChunkGenerator() {
		return new net.minecraft.world.gen.ChunkProviderGenerate(worldObj, getSeed(),
				worldObj.getWorldInfo().isMapFeaturesEnabled(), worldObj.getWorldInfo().getGeneratorOptions());
	}
}
