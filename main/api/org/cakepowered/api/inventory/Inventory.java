...
public interface Inventory {
	...
	/**
	 * Removes from the slot index (first arg) up to an amount of items (second arg)
	 * and returns a new ItemStack with the items removed
	 */
	...
	/**
	 * Returns true if automation is allowed to insert the given stack (ignoring stack size) into the given slot (index)
	 */
